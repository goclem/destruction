...
declare -a Cities=("hostomel" "irpin" "livoberezhnyi" "moschun" "rubizhne" "volnovakha" "damascus" "daraa" "deirezzor" "hama" "homs" "idlib" "raqqa") # "aleppo" 
#declare -a Cities=("damascus" "daraa" "deirezzor" "hama" "homs" "idlib" "raqqa")
#declare -a Cities=("volnovakha" "moschun")
