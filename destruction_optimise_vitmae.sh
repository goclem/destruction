...
# python3 destruction_optimise_vitmae.py --cities hostomel irpin livoberezhnyi moschun volnovakha aleppo daraa hama homs idlib raqqa
python3 destruction_optimise_vitmae.py
