...
#python3 destruction_finetune_siamese.py --cities hostomel irpin livoberezhnyi moschun rubizhne volnovakha
python3 destruction_finetune_siamese.py --cities aleppo damascus daraa deirezzor hama homs idlib raqqa
exit 0 
